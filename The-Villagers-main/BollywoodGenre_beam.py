...
def run():
     ...
     p = beam.Pipeline('DirectRunner', options=opts)
         # selecting the titleID, genre from datamart Bollywood and limiting by 490 
     sql = 'SELECT titleId, Genre FROM datamart.Bollywood limit 490'
     ...
     dataset_id = 'datamart'
     table_id = PROJECT_ID + ':' + dataset_id + '.' + 'BollywoodGenre_Beam'
