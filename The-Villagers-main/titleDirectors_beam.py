...
def run():
     ...
     p = beam.Pipeline('DirectRunner', options=opts)
         # selecting the titleId, directors from datamart title crew and limiting by 490 
     sql = 'SELECT titleId, directors FROM datamart.Title_crew limit 490'
     ...
     dataset_id = 'datamart'
     table_id = PROJECT_ID + ':' + dataset_id + '.' + 'titleDirectors_Beam'
