...
def run():
     ...
     p = beam.Pipeline('DirectRunner', options=opts)
         # selecting the titleId, genres from datamart title basics and limiting by 490 
     sql = 'SELECT titleId, genres FROM datamart.Title_basics limit 490'
     ...
     dataset_id = 'datamart'
     table_id = PROJECT_ID + ':' + dataset_id + '.' + 'titleGenres_Beam'
